...
import static ru.javawebinar.topjava.util.DateTimeUtil.DATE_TIME_FORM;
...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull
    @DateTimeFormat(pattern = DATE_TIME_FORM)
    ...
    @NotNull(message = "the Calories field should not be empty, the range of values is from 10 to 5000")
